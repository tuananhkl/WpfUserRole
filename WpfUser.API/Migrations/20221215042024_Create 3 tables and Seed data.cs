...
namespace WpfUser.API.Migrations
{
    public partial class Create3tablesandSeeddata : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Address", "Age", "DateOfBirth", "Email", "Gender", "Password", "Status", "UserName" },
                values: new object[] { 1, "Hanoi", 23, new DateTime(1999, 8, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "tuananh@gmail.com", "Male", "Tuananh123.", true, "tuananh" });
